...
export default defineComponent({
	...
	mounted() {
		...
		const menu = document.getElementById("theme-menu-small");

		document.getElementById("theme-button-small")?.addEventListener("click", (event) => {
			menu?.classList.toggle("hide");
			event.stopPropagation();
		});

		for (const button of document.getElementsByClassName("theme-option-small")) {
...
<template>
    <KeepAlive>
        <div id="theme-small">
            <button id="theme-button-small">
                <img :src="icon.default" id="icon"><span id="text">Theme</span>
            </button>
            <div id="theme-menu-small" class="hide">
                <button class="theme-option-small default" :disabled=isDefault()>
                    <img :src="icon.default" id="icon"><span id="text">OS Theme</span>
                </button>
                <button class="theme-option-small dark" :disabled=isDark()>
                    <img :src="icon.dark" id="icon"><span id="text">Dark Theme</span>
                </button>
                <button class="theme-option-small light" :disabled=!isDark()>
